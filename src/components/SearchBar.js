        ...
        return (    
            <div className="searchcontainer">
                ...
                <div className="ui grid mobile only">
                    <div className="ui row" style={{marginTop: '1em'}}>
                        <div className="nine wide mobile column right aligned"> 
                            <a href="/">
                                <span><i className="fa fa-2x fa-youtube-play" aria-hidden="true" style={{color : 'red', paddingLeft: '5px' }}></i></span>
                                <span className="youtube">YouTube</span>
                            </a> 
                        </div>
                        <div className="six wide mobile column" style={{textAlign: 'left', paddingLeft: '0px'}}>
                            <i className="fa fa-2x fa-user-circle-o" aria-hidden="true" style={{color : '#5c6bc0'}}></i>
                        </div>
                    </div> 
                    <div className="ui centered row">
                        <div className="thirteen wide mobile column" style={{textAlign: 'left'}}>
                ...
                <div className="ui grid tablet computer only">
                    <div className="ui row">
                        ...
                        <a href="/">
                            <span><i className="fa fa-2x fa-youtube-play" aria-hidden="true" style={{color : 'red', paddingLeft: '20px' }}></i></span>
                            <span className="youtube">YouTube</span>
                        </a> 
                        </div>
                        <div className="five wide mobile column centered" style={{textAlign: 'left'}}>
